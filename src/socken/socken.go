...
// B  01                      09 10 11 12 13 14 15                                                                | 8
// C     02                   09                   16 17 18 19 20 21                                              | 8 * 7
// D        03                   10                16                22 23 24 25 26                               | 8 * 7 * 6
// E           04                   11                17             22             27 28 29 30                   | 8 * 7 * 6 * 5
// F              05                   12                18             23          27          31 32 33          | 8 * 7 * 6 * 5 * 4
// G                 06                   13                19             24          28       31       34 35    | 8 * 7 * 6 * 5 * 4 * 3
// H                    07                   14                20             25          29       32    34    36 | 8 * 7 * 6 * 5 * 4 * 3 * 2
// I                       08                   15                21             26          30       33    35 36 |
//   |-----------------------|---------------------|---------------|---------------|-----------|--------|-----|---|

// apparently the math behind this is more complicted than one would think ...
// cards == num symbols = n^2 - n + 1   for n different symbols per card

// http://radiganengineering.com/2013/01/spot-it-howd-they-do-that/
var cards [][]Symbol = [][]Symbol{
	{0, 1, 2, 3, 4, 5, 6, 49},
